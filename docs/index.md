...
- Use [Backup and Recovery](/backup-and-recovery) when you need the database backup, restore, and runtime rollback path in one place
- Use [Backup/Restore Drill](/backup-restore-drill) when you want a repeatable rehearsal checklist with exact commands and evidence capture
