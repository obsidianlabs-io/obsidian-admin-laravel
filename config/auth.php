...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | These options throttle repeated failed login attempts.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | These options define minimum password strength for register/update flows.
    |
    */

    'password_policy' => [
        'min' => env('AUTH_PASSWORD_MIN', 8),
        'require_mixed_case' => env('AUTH_PASSWORD_REQUIRE_MIXED_CASE', true),
        'require_symbols' => env('AUTH_PASSWORD_REQUIRE_SYMBOLS', false),
        'check_uncompromised' => env('AUTH_PASSWORD_CHECK_UNCOMPROMISED', false),
    ],
