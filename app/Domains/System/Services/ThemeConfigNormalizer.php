...
/**
 * Handles theme config validation, normalization, defaults, and limits.
 *
 * Extracted from ThemeConfigService to reduce its complexity.
 *
...
class ThemeConfigNormalizer
{
     ...
     */
    public function diffFromDefault(array $config): array
    {
        $defaults = $this->defaultConfig();
        $stored = [];
     ...
     * @return array<string, mixed>
     */
    public function extractEditableConfig(array $config): array
    {
        $keys = [
            'themeScheme',
            'themeColor',
     ...
     * @return ThemeScheme
     */
    public function normalizeThemeScheme(mixed $value, string $fallback): string
    {
